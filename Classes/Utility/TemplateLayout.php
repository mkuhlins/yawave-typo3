...
namespace Interspark\YawavePublications\Utility;
...
class TemplateLayout implements SingletonInterface
{
    ...
    public function getAvailableTemplateLayouts($pageUid)
    {
        ...
        if (isset($GLOBALS['TYPO3_CONF_VARS']['EXT']['yawavepublications']['templateLayouts'])
            && is_array($GLOBALS['TYPO3_CONF_VARS']['EXT']['yawavepublications']['templateLayouts'])
        ) {
            $templateLayouts = $GLOBALS['TYPO3_CONF_VARS']['EXT']['yawavepublications']['templateLayouts'];
        }
    ...
    protected function getTemplateLayoutsFromTsConfig($pageUid)
    {
        ...
        if (isset($pagesTsConfig['tx_yawavepublications.']['templateLayouts.']) && is_array($pagesTsConfig['tx_yawavepublications.']['templateLayouts.'])) {
            $templateLayouts = $pagesTsConfig['tx_yawavepublications.']['templateLayouts.'];
        }
        return $templateLayouts;
    }
}
